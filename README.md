...
2. As a first-time user, proper navigation and smooth functionality to reach each TeaWhip to show details is a must.

3. As a repeat user, a `search bar` option is great to be able to find specific TeaWhips that was seen before.

4. As an avid user, TeaWhips should be a fun and an easy-to-use app, always available for a user to refer to other enthusiasts alike.
