    ...
    <div className="about-container">
      ...
      <ul className="developer-list">
        <li className="developer">
          ...
          <p className="fun-fact"> <b>Facts:</b> "Anita Owen, a passionate full-stack developer, is also a devoted mom and longtime DJ who's always thrived in dynamic environments, blending creativity with technical skill. Her journey from the turntables to the terminal, fueled by a love for problem-solving and a dedication to continuous growth, helps her to navigate the world of software development."
          </p>
        </li>
        <li className="developer">
        <h2>Brenda</h2>
                <a href= "https://github.com/BSoto85" className ="github-link" target='_blank'>
                <img src="https://res.cloudinary.com/dgifdj6nx/image/upload/v1711730824/TeaWhips-BrendaAbout_vnayip.jpg" alt="Brenda!" width="300" height="300"/>
                </a>
